            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <h3 class="text-white">Admin/Petugas</h3>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" method="post" action="cek_login2.php">
                        <div class="row p-b-30">
                            <div class="col-12">
                                ...
                                <p class="text-white"><a href="login.php">Masuk Sebagai Masyarakat</a></p>
                            </div>
                        </div>
