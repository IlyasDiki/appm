                ...
                <form class="form-horizontal">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="fname" placeholder="Masukan ID">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="password" class="form-control" id="lname" placeholder="Masukan NIK">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="file" class="form-control" id="lname" placeholder="">
                            </div>
                        </div>
                    </div>
